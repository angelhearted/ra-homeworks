...
class App extends React.Component {
	...
	render() {
		...
		return (
			<section>
        <Chart type={Chart.Types.SERIE} max={max} {...this.state}/>
        <Chart type={Chart.Types.STACKED} max={max} {...this.state}/>
        <Chart type={Chart.Types.LAYERED} max={max} {...this.state}/>
        <Chart type={Chart.Types.HORIZONTAL} max={max} {...this.state}/>
